    ...
    <section className="relative w-full bg-[#f8f9fb] overflow-hidden py-14 px-6 md:px-12 lg:px-20">
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
        ...
        <div className="flex flex-col gap-6">
          {/* Badge */}
          <p className="text-[11px] font-bold tracking-[0.18em] uppercase text-blue-600">
            Partner With Us
          </p>
...
<div className="relative mt-2">
  <div className="grid grid-cols-2 gap-6">
    {/* Large left image - NO button inside */}
    <div
  ...
  {/* Play button - completely separate, positioned in left column area */}
  <button 
    className="absolute left-[50%] top-1/2 -translate-x-1/2 -translate-y-1/2 w-18 h-18 rounded-full bg-white shadow-lg flex items-center justify-center hover:scale-105 active:scale-95 transition-transform z-50"
  ...
  <div className="absolute -bottom-12 -left-10 w-16 h-16 rounded-full overflow-hidden">
    ...
    />
        ...
        <div className="flex flex-col gap-5 pt-16">
          {/* TOP DESIGN */}
          <div className="absolute -top-10 right-0 w-[320px] h-[120px]">
            {/* Curve 1 */}
            <div>
              <img
          ...
          <p className="text-gray-600 text-md leading-relaxed max-w-120 mt-8">
            Want to promote your courses, study materials, or learning platform?
          </p>
          <p className="text-gray-900 font-bold text-[15px] leading-relaxed -mt-2 max-w-120">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6 mt-2">
            ...
            <button
              type="submit"
              className="inline-flex w-fit bg-[#2563EB] text-white font-semibold text-[15px] px-10 py-4 rounded-lg  transition-all duration-300 relative overflow-hidden group"
            >
