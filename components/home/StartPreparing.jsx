...
export default function StartPreparing() {
  ...
  START PREPARING
          ...
          <p className={`text-sm sm:text-base max-w-full md:max-w-md ${
        ...
        {/* CARDS CONTAINER */}
        <div className={`relative grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-13 md:gap-0 md:border ${
            ...
            >
              ...
              <div className="relative p-6 sm:p-8 pt-14 sm:pt-14 overflow-hidden min-h-[200px] sm:min-h-[220px]">
                ...
                <div className="relative z-10 text-left">
                  <h3 className={`font-semibold text-lg sm:text-xl mb-2 sm:mb-3 transition-colors duration-500 ${
                    darkMode 
                  ...
                  <p className={`text-sm sm:text-base mb-5 sm:mb-6 leading-relaxed transition-colors duration-500 ${
                    darkMode 
                  ...
                  <div className="flex justify-start">
                    <button className={`flex items-center gap-2 text-sm sm:text-base font-medium transition-colors duration-500 ${
                      darkMode 
              ...
              <div className="absolute -top-10 sm:-top-12 left-1/2 -translate-x-1/2 z-20">
                <div className="w-18 h-18 sm:w-20 sm:h-20 rounded-full flex items-center justify-center bg-blue-600 text-white group-hover:bg-white group-hover:text-blue-600 transition-all duration-500">
      ...
      <div className="hidden sm:block absolute right-0 -top-40 w-[200px] h-full z-10 pointer-events-none overflow-hidden">
        {/* Top small */}
        <span className={`absolute top-30 right-6 w-6 h-6 rounded-[70%_40%_55%_45%] ${
          darkMode ? "bg-blue-600" : "bg-blue-600"
        }`} />

        {/* Big middle */}
        <span className={`absolute top-40 -right-4 w-10 h-10 rounded-[70%_40%_55%_45%] ${
          darkMode ? "bg-blue-600" : "bg-blue-600"
        }`} />

        {/* Medium */}
        <span className={`absolute top-56 right-8 w-6 h-6 rounded-[70%_40%_55%_45%] ${
          darkMode ? "bg-blue-600" : "bg-blue-600"
        }`} />

        {/* Bottom small */}
        <span className={`absolute top-66 right-2 w-4 h-4 rounded-[70%_40%_55%_45%] ${
          darkMode ? "bg-blue-600" : "bg-blue-600"
        }`} />
      </div>
